...
class CalcMesh:
    ...
    def __init__(self, nodes_coords, tetrs_points):
        ...
        self.velocity[2] = 0.005 * np.power(self.nodes[0], 2)
    ...
    def move(self, tau):
        ...
        self.nodes += self.velocity * np.cos(6.28 * tau)
    ...
    def snapshot(self, snap_number):
        ...
        writer.SetFileName("calcube-step-" + str(snap_number) + ".vtu")
        writer.Write()
...
try:
    ...
    gmsh.merge(os.path.join(path, 'calibration cube.stl'))
except:
